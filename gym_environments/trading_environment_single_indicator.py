...
TickerValue = namedtuple('TickerValue', ('price', 'indicator'))
...
def create_trajectory(ticker, fromdate=default_fromdate, todate=default_todate,indicator = None):
    assert indicator
    global cached
...
class TradingEnvironment_si(gym.Env):
    ...
    def reset(self):
        ...
        self.trajectory = create_trajectory(self.ticker,indicator=self.indicator)
