...
train_fromdate = datetime(2018, 1, 1)
train_todate = datetime(2020, 9, 30)
test_fromdate = datetime(2020, 10, 1)
test_todate = datetime(2021, 4, 1)
training_envs, test_envs = generate_training_test_environments('data/ticker_list/nyse-listed.csv', num_training, num_test, seed=0,
    train_fromdate=train_fromdate,train_todate=train_todate,test_fromdate=test_fromdate,test_todate=test_todate)
